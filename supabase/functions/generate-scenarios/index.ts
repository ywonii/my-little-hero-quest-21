        ...
        messages: [
          {
            ...
            이전에 10개를 만든 습관은 버리고 반드시 1개의 상황을 만들어주세요. 각 상황마다 3가지 난이도 버전이 필요합니다.
          ...
          {
            role: "user",
            content: ` 이전에 10개를 만든 습관은 버리고 반드시 다음 주제로 1개 상황의 시나리오를 만들어주세요 (각 상황마다 3가지 난이도): ${problemDescription}`,
          },
        ],
        max_tokens: 6000,
        temperature: 0.7,
