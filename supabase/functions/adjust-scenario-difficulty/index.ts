...
serve(async (req) => {
  ...
  try {
    ...
    const difficultyInstructions = {
      beginner: {
        title: '초등학교 1학년 수준으로 매우 쉽고 간단한 단어를 사용하되 원본 길이를 최대한 유지하세요.',
        situation: '초등학교 1학년이 이해할 수 있는 매우 간단한 문장과 기본 어휘로 작성하되 원본 길이를 최대한 유지하세요.',
        options: '초등학교 1학년이 읽을 수 있는 매우 간단한 단어와 문장으로 작성하되 원본 길이를 최대한 유지하세요.'
      },
      intermediate: {
      ...
      advanced: {
        title: '초등학교 3학년 수준의 고급 어휘를 사용하되 원본 길이를 최대한 유지하세요.',
        situation: '초등학교 3학년이 이해할 수 있는 고급 어휘를 사용하되 원본 상황 설명의 길이와 구조를 최대한 유지하세요.',
        options: '초등학교 3학년 수준의 고급 어휘를 사용하되 원본 선택지의 길이를 최대한 유지하세요.'
      }
    };
